...
Demo.Player.prototype.constructor = Demo.Player;

Demo.Player.prototype.update = function() {
  if (this.spawning) {
    return;
  }
...
// STATES //
Demo.Player.prototype.pausedState = function() {
...
Demo.Player.prototype.groundState = function() {
...
Demo.Player.prototype.airState = function() {
  // delayed "onGround" check for better controls
  if (this.wasOnGround) {
...
Demo.Player.prototype.wallSlideState = function() {
...
Demo.Player.prototype.drillState = function() {
  this.drilling = true;
  this.drillCharge--;
  // drill out of charge
...
// UTILITIES //
Demo.Player.prototype.moveX = function() {
...
// INPUT HANDLERS
Demo.Player.prototype.jumpBtnHandler = function() {
...
Demo.Player.prototype.drillBtnHandler = function() {
  if (this.spawning) {
    return;
  }
  if (this.drillCharge <= 0) {
  ...
  if (Demo.drillEnabled && this.currentState != this.pausedState) {

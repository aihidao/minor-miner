...
// Demo.Input.prototype = Object.create(Object.prototoype);
Demo.Input.prototype.constructor = Demo.Input;

Demo.Input.prototype.update = function() {
...
// GET BUTTON OBJECTS //
Demo.Input.prototype.leftIsDown = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.rightIsDown = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.primaryPressed = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.secondaryPressed = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.secondaryReleased = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.startPressed = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.directionsToString = function() {
  if (this.usingXbox) {
...
Demo.Input.prototype.primaryBtnToString = function() {
  if (this.usingXbox) {
    return 'a button';
  }
  return 'x key';
...
Demo.Input.prototype.secondaryBtnToString = function() {
  if (this.usingXbox) {
    return 'x button';
  }
  return 'z key';
...
Demo.Input.prototype.startBtnToString = function() {
  if (this.usingXbox) {
    return 'start';
  }
  return 'spacebar';
...
Demo.Input.prototype.destroy = function() {
  // nothing
};

Demo.Input.prototype.resetPrimary = function() {
  this.kbPrimaryTimer = 0;
  this.kbPrimaryDown = false;
  this.kbPrimaryPressed = false;
  this.kbPrimaryLast = this.kbPrimaryDown;
